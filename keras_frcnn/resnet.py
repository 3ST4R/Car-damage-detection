...
def get_weight_path(path='models'):
    if K.image_dim_ordering() == 'th':
        return get_file('resnet50_weights_th_dim_ordering_th_kernels_notop.h5',
                                        TH_WEIGHTS_PATH_NO_TOP,
                                        cache_subdir=path,
                                        md5_hash='f64f049c92468c9affcd44b0976cdafe')
    else:
        return get_file('resnet50_weights_tf_dim_ordering_tf_kernels.h5',
                                        TF_WEIGHTS_PATH,
                                        cache_subdir=path,
